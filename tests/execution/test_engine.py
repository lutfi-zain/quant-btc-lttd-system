...
def test_engine_run_pipeline_multiday(tmp_path):
    ...
    assert day1_res["target_exposure"] == pytest.approx(1.0250385)
    ...
    with get_connection(db_path) as conn:
        ...
        assert row["target_exposure"] == pytest.approx(1.0250385)
    ...
    assert day2_res["target_exposure"] == pytest.approx(1.0085162952937705)
    ...
    with get_connection(db_path) as conn:
        ...
        assert row["target_exposure"] == pytest.approx(1.0085162952937705)
    ...
    assert day3_res["target_exposure"] == pytest.approx(0.8371258021223958)
    ...
    with get_connection(db_path) as conn:
        ...
        assert row["target_exposure"] == pytest.approx(0.8371258021223958)

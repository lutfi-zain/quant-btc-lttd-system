...
def test_no_forbidden_imports():
    ...
    """
    regime_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../src/regime"))
                ...
                for node in ast.walk(tree):
                    ...
                    if isinstance(node, ast.Import):
                        for name in node.names:
                            ...
                            if (
                                import_name == "signals" or import_name.startswith("signals.") or
                                import_name == "features" or import_name.startswith("features.") or
                                import_name == "src.signals" or import_name.startswith("src.signals.") or
                                import_name == "src.features" or import_name.startswith("src.features.")
                            ):
                    ...
                    # Check 'from xxx import yyy'
                        ...
                        if level == 0 and module:
                            # Absolute import
                            if (
                                module == "signals" or module.startswith("signals.") or
                                module == "features" or module.startswith("features.") or
                                module == "src.signals" or module.startswith("src.signals.") or
                                module == "src.features" or module.startswith("src.features.")
                            ):
                                raise AssertionError(
                            ...
                            if level >= 2 and module:
                                if module == "signals" or module.startswith("signals.") or module == "features" or module.startswith("features."):
                                    raise AssertionError(

...
class WFOEnsemble:
    ...
    def recalibrate_ou_halflife(self, log_returns: pd.Series, train_end: pd.Timestamp, train_window_days: int = 1095) -> float:
        """
    ...
    def run_wfo_calibration(self, log_returns: pd.Series, start_date: pd.Timestamp, end_date: pd.Timestamp, legacy_fixed_window: bool = False) -> pd.Series:
        """

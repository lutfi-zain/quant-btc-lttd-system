...
## Non-Goals
- Pruning multicollinear features (Layer 3 responsibility).
- Executing trades or sizing positions (Layer 5 responsibility).
- Running HMM Regime detection (Layer 1 responsibility).

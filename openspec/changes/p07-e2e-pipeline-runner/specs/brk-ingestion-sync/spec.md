# Capability: brk-ingestion-sync

## Non-Goals
- Processing minute or hourly level resolution data.
- Writing data to an external data warehouse (other than the local SQLite database).
- Replacing standard OHLCV price fetching from exchanges.

...
### Non-Goals
- Parallel execution of gap dates (sequential execution required for sizing correctness)
- Filling interior gaps (holes in the middle of existing data)
- Modifying any indicator, ensemble, or sizing logic
- Replacing `backfill_all.py` for full historical reconstruction

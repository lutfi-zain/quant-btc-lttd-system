# Spec: HMM Regime Classification

## Non-Goals
- Executing trades or applying position sizing directly from the Regime Detection layer.
- Computing Layer 2 Technical Indicators (e.g., Kalman RSI, FDI) or On-Chain Metrics (e.g., STH-MVRV, NUPL).
- Running intra-day (e.g., 1-hour) regime inferences; the system operates exclusively at the daily level.
- Applying Walk-Forward Optimization (WFO) to the HMM itself; WFO is exclusively reserved for the Ensemble Aggregation layer.

## Non-Goals
- Implementing the 3-state HMM Regime detection.
- Building the PCA orthogonalization or WFO-trained ensemble.
- Calculating final Indicator Scores (e.g., Kalman RSI).

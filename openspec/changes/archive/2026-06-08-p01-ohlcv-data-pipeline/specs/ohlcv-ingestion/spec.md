## Non-Goals
- Fetching or processing on-chain metrics (e.g., STH-MVRV, NUPL) from BRK.
- Computing technical indicators or producing Indicator Scores.
- Executing trades or evaluating Regime states.
